...
################################################################################    
    ...
    def color_create():
        ...
        return render_template('color_form.html', title='Создать цвет', color=None)
    ...
    def color_edit(id):
        ...
        return render_template('color_form.html', title='Редактировать цвет', color=color)
...
################################################################################
    ...
    def fittings():
        ...
        return render_template('fittings.html', fittings=fittings, show_header=True)
    ...
    def fitting_create():
        if request.method == 'POST':
            ...
            if 'picture' in request.files:
                fitting.path_picture = save_fitting_image(request.files['picture'], name)
        ...
        return render_template('fitting_form.html', title='Создать фурнитуру', fitting=None)
    ...
    def fitting_edit(id):
        ...
        return render_template('fitting_form.html', title='Редактировать фурнитуру', fitting=fitting)
...
################################################################################
    ...
    # Просмотр всех типов кухни
    @app.route('/kitchen-types')
    def kitchen_types():
    ...
    def kitchen_type_create():
        if request.method == 'POST':
            ...
            existing = KitchenType.query.filter_by(short_name=short_name).first()
            if existing:
                flash('Тип кухни с таким коротким именем уже существует!', 'error')
        ...
        return render_template('kitchen_type_form.html', title='Создать тип кухни', kitchen_type=None)
    ...
    def kitchen_type_edit(id):
        ...
        return render_template('kitchen_type_form.html', title='Редактировать тип кухни', kitchen_type=kitchen_type)
...
################################################################################
    ...
    def kitchen_base():
        ...
        return render_template('kitchen_base.html', bases=bases, show_header=True)
